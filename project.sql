...
ALTER TABLE `commend`
  ...
  ADD UNIQUE KEY `user_id_2` (`user_name`);
...
--
ALTER TABLE `commend`
  ADD CONSTRAINT `commend_ibfk_1` FOREIGN KEY (`news_id`) REFERENCES `news` (`id`);

--
-- 限制表 `news`
--
ALTER TABLE `news`
  ADD CONSTRAINT `news_ibfk_2` FOREIGN KEY (`type`) REFERENCES `news_type` (`id`);
COMMIT;
